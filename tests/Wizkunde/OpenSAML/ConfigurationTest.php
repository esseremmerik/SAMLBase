...
class ConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIdpSigningCertificateSetProperly()
    {
        ...
        $this->assertInstanceOf('Wizkunde\OpenSAML\Configuration\Certificate', $this->configuration->getIdpSigningCertificate());
    }
    ...
    public function testIdpEncryptionCertificateSetProperly()
    {
        ...
        $this->assertInstanceOf('Wizkunde\OpenSAML\Configuration\Certificate', $this->configuration->getIdpEncryptionCertificate());
    }
